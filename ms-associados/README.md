...
Microsservico responsavel pelo dominio de associados no ecossistema de votacao.

## Visao geral

- Projeto: `ms-associados`
...
spring.application.name=ms-associados
spring.datasource.url=${dburl-associados}
...
- `.github/workflows/workflow-backend-associados.yml`
