...
class AssociadoRestControllerIntegrationTest {
    ...
    void testeAssociadoQuandoConsultarAssociadosThenStatus200() throws Exception {
        AssociadoDto joao = AssociadoDto.builder().id(1L).nome("Joao Silva").email("joao@example.com").build();
        AssociadoDto maria = AssociadoDto.builder().id(2L).nome("Maria Santos").email("maria@example.com").build();
        AssociadoDto pedro = AssociadoDto.builder().id(3L).nome("Pedro Oliveira").email("pedro@example.com").build();
