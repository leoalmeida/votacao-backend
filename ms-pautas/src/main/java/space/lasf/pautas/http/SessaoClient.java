...
public interface SessaoClient {
    ...
    SessaoDto buscarSessaoPorId(@PathVariable Long idSessao, @PathVariable Long idAssociado);

    @PostMapping("/v1/sessoes")
    SessaoDto criarSessao(@RequestBody PautaDto pautaDto, @RequestParam boolean iniciarSessao);
